...
namespace DbContexts.Migrations
{
    ...
    [Migration("20190220195027_anotherNewLocalization")]
    partial class anotherNewLocalization
    {
            ...
            modelBuilder.Entity("Models.DbModels.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 20, 21, 50, 26, 239, DateTimeKind.Unspecified).AddTicks(5866), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            RoleId = 2,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 20, 21, 50, 26, 240, DateTimeKind.Unspecified).AddTicks(9591), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "بائع",
                            RoleNameEn = "Seller"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 20, 21, 50, 26, 240, DateTimeKind.Unspecified).AddTicks(9606), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "مستخدم",
                            RoleNameEn = "User"
                        });
                });
