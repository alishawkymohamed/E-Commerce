...
namespace DbContexts.Migrations
{
    ...
    [Migration("20190206173941_MoreLocalized")]
    partial class MoreLocalized
    {
            ...
            modelBuilder.Entity("Models.DbModels.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 6, 19, 39, 41, 218, DateTimeKind.Unspecified).AddTicks(2661), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            RoleId = 2,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 6, 19, 39, 41, 219, DateTimeKind.Unspecified).AddTicks(8542), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "بائع",
                            RoleNameEn = "Seller"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 6, 19, 39, 41, 219, DateTimeKind.Unspecified).AddTicks(8561), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "مستخدم",
                            RoleNameEn = "User"
                        });
                });
