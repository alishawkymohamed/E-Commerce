...
namespace DbContexts.Migrations
{
    ...
    [Migration("20190228150917_LoginLocalization")]
    partial class LoginLocalization
    {
            ...
            modelBuilder.Entity("Models.DbModels.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 28, 17, 9, 17, 58, DateTimeKind.Unspecified).AddTicks(8907), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            RoleId = 2,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 28, 17, 9, 17, 60, DateTimeKind.Unspecified).AddTicks(2672), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "بائع",
                            RoleNameEn = "Seller"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 2, 28, 17, 9, 17, 60, DateTimeKind.Unspecified).AddTicks(2687), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "مستخدم",
                            RoleNameEn = "User"
                        });
                });
