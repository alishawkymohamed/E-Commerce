...
namespace DbContexts.Migrations
{
    ...
    [Migration("20190531030832_addLocalization4")]
    partial class addLocalization4
    {
            ...
            modelBuilder.Entity("Models.DbModels.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 5, 31, 5, 8, 31, 276, DateTimeKind.Unspecified).AddTicks(8840), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            RoleId = 2,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 5, 31, 5, 8, 31, 279, DateTimeKind.Unspecified).AddTicks(2193), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "بائع",
                            RoleNameEn = "Seller"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 5, 31, 5, 8, 31, 279, DateTimeKind.Unspecified).AddTicks(2218), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "مستخدم",
                            RoleNameEn = "User"
                        });
                });
