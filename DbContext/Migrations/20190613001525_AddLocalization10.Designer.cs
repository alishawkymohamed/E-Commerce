...
namespace DbContexts.Migrations
{
    ...
    [Migration("20190613001525_AddLocalization10")]
    partial class AddLocalization10
    {
            ...
            modelBuilder.Entity("Models.DbModels.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 6, 13, 2, 15, 24, 981, DateTimeKind.Unspecified).AddTicks(8526), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            RoleId = 2,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 6, 13, 2, 15, 24, 983, DateTimeKind.Unspecified).AddTicks(5404), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "بائع",
                            RoleNameEn = "Seller"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedOn = new DateTimeOffset(new DateTime(2019, 6, 13, 2, 15, 24, 983, DateTimeKind.Unspecified).AddTicks(5415), new TimeSpan(0, 2, 0, 0, 0)),
                            RoleNameAr = "مستخدم",
                            RoleNameEn = "User"
                        });
                });
